...
def split():
    ...
    # change the random_state to modify the seed for the shuffle, Default = 2, Invariance Test = 3
    # remember that the output is into the data folder, it will rewrite the base train and test csv
    # so after creating the needed train and test set, move them into a new folder and recreate the
